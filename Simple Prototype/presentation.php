    ...
    <div id="Main">
        ...
        <div id="content">
            <div id="content_inner">
                ...
                </sizer><a href="#myCarousel" data-slide="prev" style="margin-top: 10px; margin-left: 280px; left:50%; position:absolute;" class="btn btn-large btn-primary" href="#">Previous</a></sizer>
                </sizer><a href="#myCarousel" data-slide="next" style="margin-top: 10px; margin-left: 374px; left:50%; position:absolute;" class="btn btn-large btn-primary" href="#">Next</a></sizer>
            </div>
        </div>
    </div>
